  ...
  return (<>
    <div className='min-h-[80vh] bg-primary grid grid-cols-12 items-center gap-8 py-10 sm:grid-cols-1'>
      <div className='col-span-8 sm:col-span-1 sm:order-2 flex flex-col items-start justify-center gap-8 min-w-0 pr-6 xl:pr-3 sm:pr-0'>
        ...
        <div onMouseEnter={enter} onMouseLeave={leave} className='flex flex-row items-end gap-3 xl:gap-2 flex-nowrap w-full'>
          ...
          <Link to="/admin-login" className="cursor-none inline-flex items-center">
            <Eye/>
          </Link>
        </div>
      ...
      <div className='col-span-4 sm:col-span-1 sm:order-1 flex items-center justify-center sm:mt-2'>
